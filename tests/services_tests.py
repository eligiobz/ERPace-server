...
class ServiceTestCase(unittest.TestCase):
    ...
    def setupClass(self):
        ...
        engine.execute(
            "insert into products_masterlist(barcode, name, price) values('2000', 'prod_1', 10);")
        engine.execute(
            "insert into product(barcode, units, storeid) values('2000', 5 , 1);")
    ...
    def tearDownClass(cls):
        engine.execute(
            'delete from service_price_history; delete from services;')
